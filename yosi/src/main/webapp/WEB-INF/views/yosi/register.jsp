...
<table class="table table-bordered">
    ...
    <tbody>
        <form method="post">
            ...
            <tr>
                <th>작성자: </th>
                <td><input type="text" placeholder="작성자 이름입니다.. " name="writer" class="form-control"/></td>
            </tr>
            <tr>
                <th>첨부파일: </th>
            ...
            <tr>
                <td colspan="2">
                    <button class="myButton pull-right" type="submit"/>등록하기</button>
                    
                                        
                </td>
            </tr>
        </form>
        <a href='/yosi/list?page=${cri.page}'><button class="meButton pull-right">목록으로</button></a>
    </tbody>
</table>
</div>
</body>
