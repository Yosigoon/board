...
<body>
							...
							<li><span class="fa-gears ">Features</span>
								<ul>
									<li class="parent"><span>Typography</span>
										<ul>
											<li><a href="features-typo-basic.html">Undeveloped</a></li>
										</ul></li>
								</ul></li>
							<li><span class="fa-copy ">Pages</span>
								<ul>
									<li><a href="http://localhost:8080/yosi/login">Login</a></li>
									<li><a href="pages-404.html">404 Error Page</a></li>
								</ul></li>
							<li><span class="fa-th ">Portfolio</span>
								<ul>
									<li><a href="http://localhost:8080/yosi/list">Board</a></li>
								</ul></li>
							<li><span class="fa-font ">Blog</span>
								<ul>
									<li><a href="blog-list.html">Undeveloped</a></li>
								</ul></li>
	...
	<div id="welcome" class="background-white">
		<div class="container">
			<div class="row margin-vert-40">
				<!-- Main Text -->
				<div class="col-md-12">
					<h2 class="text-center article-title">Welcome to Yosi Notice
						Board</h2>
					<p class="text-center">Lorem ipsum dolor sit amet, consectetuer
						adipiscing elit, sed diam nonummy nibh euismod tincidunt ut
						laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim
						veniam, quis nostrud exerci tation ullamcorper suscipit lobortis
						nisl ut aliquip ex ea commodo consequat.</p>
					<img class="fadeInUp animate" alt=""
						src="/resources/img/responsive_homepage.jpg"
	...
	<!-- Icons -->
	<div id="icons" class="parallax-bg1 text-light background-primary"
			...
			<div class="row margin-vert-40">
				...
				<div class="col-md-4 text-center animate fadeInLeft">
					...
					<p>Nam liber tempor cum soluta nobis eleifend option congue
						nihil imperdiet doming id quod mazim placerat facer.</p>
				</div>
	...
	<div id="content" class="background-white">
		<div class="container">
			<div class="row margin-vert-40">
				<div class="col-md-12">
					<h2 class="text-center article-title">My Project and Hobby</h2>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam
						sapien risus, blandit at fringilla ac, varius sed dolor. Donec
						augue lacus, vulputate sed consectetur facilisis, interdum
						pharetra ligula. Nulla suscipit erat nibh, ut porttitor nisl
						dapibus eu.</p>
					<p>Phasellus porta eros vel lacus euismod consequat. Phasellus
						eleifend, nibh non feugiat hendrerit, lacus enim adipiscing eros,
						a pharetra erat neque eget est. Quisque vitae aliquet urna.
						Integer suscipit lectus eu enim porttitor fringilla. Ut blandit,
						urna in auctor euismod, arcu eros pharetra metus, a porta purus
						libero a nibh.</p>
					<p>Nam eget urna pellentesque nisl ultrices dapibus. Mauris
						accumsan vehicula nisl, sed tempus mauris facilisis eu. Donec a
						iaculis nisi, quis malesuada justo. Pellentesque ut enim sit amet
						ipsum dignissim egestas. Morbi tincidunt rhoncus urna eget
						placerat.</p>
				</div>
			</div>
		</div>
	...
	<!-- End Content -->
	<!-- Portfolio -->
	<div id="porfolio" class="parallax-bg2"
		style="background-position: 50% 0%;"
		data-stellar-background-ratio="0.5">
		<div class="container">
						...
						<figure class="animate fadeInLeft">
							<div class="grid-image">
								<div class="featured-info">
									<div class="info-wrapper">My favorite baseball team</div>
								</div>
								<img alt="image1" src="/resources/img/frontpage/image01.jpg">
							</div>
						</figure>
					</a>
				</div>
					...
					<a href="#">
						<figure class="animate fadeInUp">
							<div class="grid-image">
								...
								<img alt="image2" src="/resources/img/frontpage/image02.jpg">
							</div>
						</figure>
					</a>
				</div>
					...
					<a href="#">
						<figure class="animate fadeInRight">
							<div class="grid-image">
								...
								<img alt="image3" src="/resources/img/frontpage/image03.jpg">
							</div>
						</figure>
					</a>
				</div>
					...
					<a href="#">
						<figure class="animate fadeInLeft">
							<div class="grid-image">
								...
								<img alt="image4" src="/resources/img/frontpage/image04.jpg">
							</div>
						</figure>
					</a>
				</div>
					...
					<a href="#">
						<figure class="animate fadeInUp">
							<div class="grid-image">
								...
								<img alt="image5" src="/resources/img/frontpage/image05.jpg">
							</div>
						</figure>
					</a>
				</div>
					...
					<a href="#">
						<figure class="animate fadeInRight">
							<div class="grid-image">
								...
								<img alt="image6" src="/resources/img/frontpage/image06.jpg">
							</div>
						</figure>
					</a>
				</div>
	...
	<!-- End Portfolio -->
	<!-- Hiring -->
	<div id="hiring" class="parallax-bg3 text-light"
		style="background-position: 50% 0%;"
		data-stellar-background-ratio="0.5">
		<div class="container">
			<div class="row">
				<div class="col-md-12 margin-vert-40">
					<h2 class="animate fadeIn" style="text-align: center;">We are
						Hiring!</h2>
					<hr>
					<p class="animate fadeIn" style="text-align: center;">
						Mauris accumsan vehicula nisl, sed tempus mauris facilisis eu.
						Donec a iaculis nisi, quis malesuada justo. <br>Pellentesque
						ut enim sit amet ipsum dignissim egestas. Morbi tincidunt rhoncus
						urna eget placerat.
					</p>
					<p class="animate fadeInUp" style="text-align: center;">
						<button class="btn btn-lg btn-primary" type="button">View
							Details</button>
					</p>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-6 margin-bottom-30">
					...
					<p>All stock images on this template demo are for presentation
						...
						membership plans.</p>
					<p>
						Dribbble images are property of their respective owners. All other
						images are freely available from <a class="nobold"
							href="http://www.unsplash.com/" target="_blank">Unsplash</a>.
					</p>
				</div>
				<!-- End Disclaimer -->
				<!-- Image Credits -->
				<div class="col-sm-6 col-md-3 margin-bottom-30">
					<h3 class="margin-bottom-10">Reference link</h3>
					<ul class="menu">
						<li><a href="http://www.gameone.kr/" target="_blank">Game
								One</a></li>
						<li><a href="https://github.com/Yosigoon/yosi"
	...
	<div id="footer" class="background-dark text-light">
		<div class="container no-padding">
			<div class="row">
				...
				<div id="copyright" class="col-md-4">
					<p class="pull-right">(c) 2017 Yosi Copyright Info</p>
				</div>
				<!-- End Copyright -->
			</div>
		</div>
		...
		<!-- Stellar Parallax -->
		<script type="text/javascript" src="/resources/js/jquery.stellar.js"
			charset="utf-8"></script>
		<!-- Sticky Div -->
