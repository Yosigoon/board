				...
				<form method="post" action="yosi/view">
					...
					<tr>
						...
						<td><textarea cols="10" placeholder="내용을 입력하세요. "
								name="contents" class="form-control" readonly="readonly"
					...
					<tr>
						<td colspan="2">
							<button class="btn myButton pull-right" data-oper='mod' type="button" id="btnUpdete">수정</button>
							<button class="btn yButton pull-right" data-oper='del' type="button" id="btnDelete">삭제</button>
						</td>
					</tr>
				</form>
				등록 날짜 :
